...
namespace cast {
  ...
  public:
    ...
    virtual ::cast::interfaces::CASTComponentPrx newComponent(const ::std::string& id, 
							      const ::std::string& type, 
							      const bool newComponent,
							      const ::Ice::Current & _crt)
            throw (ComponentCreationException);

    virtual ::cast::interfaces::ManagedComponentPrx newManagedComponent(const ::std::string& id, 
									const ::std::string& type, 
									const bool newComponent,
									const ::Ice::Current & _crt)
            throw (ComponentCreationException);

    virtual ::cast::interfaces::UnmanagedComponentPrx newUnmanagedComponent(const ::std::string& id, 
									    const ::std::string& type, 
									    const bool newComponent,
									    const ::Ice::Current & _crt)
            throw (ComponentCreationException);

    virtual ::cast::interfaces::WorkingMemoryPrx newWorkingMemory(const ::std::string& id, 
								  const ::std::string& type, 
								  const bool newComponent,
								  const ::Ice::Current & _crt) 
            throw (ComponentCreationException);
    
    virtual ::cast::interfaces::TaskManagerPrx newTaskManager(const ::std::string& id, 
							      const ::std::string& type, 
							      const bool newComponent,
							      const ::Ice::Current & _crt)
      throw (ComponentCreationException);
    ...
    virtual std::string getVersionString(const ::Ice::Current & _crt) {
