...
be installed from the standard repositories.
 ...
 - <a href="http://www.zeroc.com/ice.html">Ice</a> version 3.3 or above for C++, Java and Python.
...
by the Ice java package, and the liblog4j1.2-java file installed by
log4j, are included in your classpath. You can add...
