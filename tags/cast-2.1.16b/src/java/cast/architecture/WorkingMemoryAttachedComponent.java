...
public abstract class WorkingMemoryAttachedComponent extends
	 ...
	 */
	public final int getStoredVersionNumber(String _id)
			throws ConsistencyException {
	 ...
	 * @return
	 */
	public final boolean isVersioned(String _id) {
	 ...
	 */
	public final boolean haveLatestVersion(String _id)
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public void checkConsistency(String _id, String _subarch)
			throws ConsistencyException, DoesNotExistOnWMException,
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public boolean haveLatestVersion(String _id, String _subarch)
			throws ConsistencyException, DoesNotExistOnWMException,
			UnknownSubarchitectureException {
		assert (isVersioned(_id));
	 ...
	 *             if communication goes awry
	 */
	public void checkConsistency(WorkingMemoryAddress _wma)
			throws ConsistencyException, DoesNotExistOnWMException,
			UnknownSubarchitectureException {
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public void lockEntry(String _id, String _subarch,
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public void lockEntry(WorkingMemoryAddress _wma,
			WorkingMemoryPermissions _permissions)
			throws DoesNotExistOnWMException, UnknownSubarchitectureException {
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public void unlockEntry(WorkingMemoryAddress _wma)
			throws ConsistencyException, DoesNotExistOnWMException,
			UnknownSubarchitectureException {
	 ...
	 * @throws WMException
	 */
	public void unlockEntry(String _id, String _subarch)
			throws ConsistencyException, DoesNotExistOnWMException,
			UnknownSubarchitectureException {
		assert _id.length() != 0 : "id must not be empty";
		assert _subarch.length() != 0 : "sa must not be empty";
	 ...
	 * @throws SubarchitectureProcessException
	 */
	public boolean tryLockEntry(String _id, String _subarch,
			WorkingMemoryPermissions _permissions)
			throws DoesNotExistOnWMException, UnknownSubarchitectureException {
		assert _id.length() != 0 : "id must not be empty";
		assert _subarch.length() != 0 : "sa must not be empty";
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public boolean tryLockEntry(WorkingMemoryAddress _wma,
			WorkingMemoryPermissions _permissions)
			throws DoesNotExistOnWMException, UnknownSubarchitectureException {
	 ...
	 * @throws WMException
	 */
	public WorkingMemoryPermissions getPermissions(WorkingMemoryAddress _wma)
			throws DoesNotExistOnWMException, UnknownSubarchitectureException {
	 ...
	 * @throws WMException
	 */
	public boolean isOverwritable(String _id, String _subarch)
			throws DoesNotExistOnWMException, UnknownSubarchitectureException {
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public boolean isDeletable(String _id, String _subarch)
			throws DoesNotExistOnWMException, UnknownSubarchitectureException {
	 ...
	 * @throws UnknownSubarchitectureException
	 */
	public boolean isReadable(String _id, String _subarch)
			throws DoesNotExistOnWMException, UnknownSubarchitectureException {
	 ...
	 * @throws ConsistencyException
	 */
	public void unlockEntry(String _id) throws ConsistencyException,
			DoesNotExistOnWMException {
		try {
	 ...
	 */
	public void lockEntry(String _id, WorkingMemoryPermissions _permissions)
			throws DoesNotExistOnWMException {
		try {
	 ...
	 * @throws WMException
	 */
	public boolean isOverwritable(String _id) throws WMException {
	 ...
	 * @throws WMException
	 */
	public boolean isDeletable(String _id) throws WMException {
	 ...
	 * @throws WMException
	 */
	public boolean isReadable(String _id) throws WMException {
	 ...
	 * @return
	 */
	public boolean holdsLock(String _id) {
	 ...
	 * @return
	 */
	public boolean holdsLock(String _id, String _subarch) {
	 ...
	 * @return
	 */
	public boolean holdsOverwriteLock(String _id) {
	 ...
	 * @return
	 */
	public boolean holdsDeleteLock(String _id) {
	 ...
	 * @return
	 */
	public boolean holdsReadLock(String _id) {
		WorkingMemoryPermissions permissions = m_permissions
				.getPermissions(_id);
		return permissions != null
	 ...
	 * @return
	 */
	public boolean holdsOverwriteLock(String _id, String _subarch) {
		// any lock is an overwrite lock
	 ...
	 * @return
	 */
	public boolean holdsDeleteLock(String _id, String _subarch) {
	 ...
	 * @return
	 */
	public boolean holdsReadLock(String _id, String _subarch) {
		WorkingMemoryPermissions permissions = m_permissions.getPermissions(
				_id, _subarch);
		return permissions != null
				&& permissions == WorkingMemoryPermissions.LOCKEDODR;
