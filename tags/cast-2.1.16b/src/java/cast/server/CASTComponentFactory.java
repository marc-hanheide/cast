...
public class CASTComponentFactory extends _ComponentFactoryDisp {
	...
	public CASTComponentPrx newComponent(String _id, String _type, boolean _newProcess, 
			Current __current) throws ComponentCreationException {
		ObjectPrx base = createBase(_id, _type, _newProcess, __current);
	...
	public ManagedComponentPrx newManagedComponent(String _id, String _type, boolean _newProcess,
			Current __current) throws ComponentCreationException {
		ObjectPrx base = createBase(_id, _type, _newProcess, __current);
	...
	public TaskManagerPrx newTaskManager(String _id, String _type, boolean _newProcess,
			Current __current) throws ComponentCreationException {
		ObjectPrx base = createBase(_id, _type, _newProcess, __current);
	...
	public UnmanagedComponentPrx newUnmanagedComponent(String _id,
			String _type, boolean _newProcess, Current __current) throws ComponentCreationException {
		ObjectPrx base = createBase(_id, _type, _newProcess, __current);
	...
	public WorkingMemoryPrx newWorkingMemory(String _id, String _type, boolean _newProcess,
			Current __current) throws ComponentCreationException {
		ObjectPrx base = createBase(_id, _type, _newProcess, __current);
	...
	private ObjectPrx createBase(String _id, String _type, boolean _newProcess, Current __current)
	...
	public String getVersionString(Current __current) {
		return CASTRELEASESTRING.value;
	}
